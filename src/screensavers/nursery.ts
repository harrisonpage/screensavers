...
// https://www.shadertoy.com/view/ltjSDW

import { createShaderToyScreensaver } from './shadertoy';

export function createNursery() {
  return createShaderToyScreensaver('Nursery', 'Star nursery clouds', `
// Built from the basics of 'Clouds' Created by inigo quilez - iq/2013
// License Creative Commons Attribution-NonCommercial-ShareAlike 3.0 Unported License.
// Edited by Dave Hoskins into "Star Nursery"
...
//----------------------------------------------------------------------
// Pure math 3D noise (no texture lookup)
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    // Autonomous camera drift replacing iMouse
    vec2 mo = vec2(0.5 + 0.3*sin(iTime*0.05), 0.4 + 0.1*sin(iTime*0.07));
