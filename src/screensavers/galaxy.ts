// Created by macbooktall in 2015-11-14
...
export function createGalaxy() {
  return createShaderToyScreensaver('Galaxy', 'Stars and galaxy', `
// Created by macbooktall in 2015-11-14
// License CC0: Stars and galaxy
...
float fbm(vec2 p, float o, float s) {
  p *= s;
  p += o;

  float aa = 0.5;
  mat2 rr = 2.04*ROT(1.0);
...
vec3 grid(vec3 ro, vec3 rd, vec2 sp) {
  ...
  return 0.25*vec3(tanh_approx(col.x), tanh_approx(col.y), tanh_approx(col.z));
}
