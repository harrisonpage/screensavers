...
export function createNightDriver() {
  return createShaderToyScreensaver('Driver', 'Rainy nighttime driving with bokeh lights', `
// "The Drive Home" by Martijn Steinrucken aka BigWings - 2017
// License Creative Commons Attribution-NonCommercial-ShareAlike 3.0 Unported License.
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    // Autonomous camera drift (replaces mouse interaction)
    vec2 mouse = vec2(sin(iTime * 0.02) * 0.3 + 0.5, 0.5);
