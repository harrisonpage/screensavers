...
// Wolfenstein by Reinder Nijhoff
// https://www.shadertoy.com/view/4sfGWX
// Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License.

export function createWolfenstein() {
  return createShaderToyScreensaver('Wolfenstein', 'Wolfenstein 3D raycaster by Reinder Nijhoff', `
