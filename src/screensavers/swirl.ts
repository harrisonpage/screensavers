...
// Swirl by borisvanschooten (based on Darwin226's shader)
// Original: https://www.shadertoy.com/view/4dX3Rf

export function createSwirl() {
  return createShaderToyScreensaver('Swirl', 'Colorful hypnotic swirl', `
